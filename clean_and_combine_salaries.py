...
def scrape_2026_stats():
    ...
    # Handle TOT rows (keep TOT, remove partial-team rows for those players)
    tot_players = set(stats[(stats['Team'] == 'TOT') | (stats['Team'] == '2TM') | (stats['Team'] == '3TM') | (stats['Team'] == '4TM')]['Player'].unique())
    stats = stats[~((stats['Player'].isin(tot_players)) & (stats['Team'] != 'TOT'))]
...
if __name__ == "__main__":
    ...
    # Save
    output = "data/nba_stats_and_salaries_2020_2025.csv"
